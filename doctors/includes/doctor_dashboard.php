<?php
$allrdvs = getDoctorRdv($doctor['id']);
...
<div class="row d-flex justify-content-around">
    <div class="col-md-12 col-lg-5 overflow-hidden" style="max-height:400px" data-aos="fade-right">
        <div class="card">
            <div class="card-body">
    ...
    <div class="col-md-12 col-lg-5" style="max-height:400px" data-aos="fade-left">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col d-flex flex-column justify-content-evenly">
                                    <h5 class="text-secondary text-uppercase"><?php echo $user['first_name'] . " " . $user['last_name'] ?></h5>
...
<div class="row gap-4 d-flex justify-content-center">
    <?php if ($carnets) : ?>
        <?php foreach ($carnets as $carnet) : ?>
            ...
            <div class="col-md-12 col-lg-3 bg-white shadow rounded border-top border-3 border-success" style="max-width:300px" data-aos="fade-down">
                <div class="rounded">
