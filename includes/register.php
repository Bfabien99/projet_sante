...
<section class="page-section bg-primary" id="about">
    <h1 class="text-light text-center text-uppercase text-decoration-underline">Espace Inscription</h1>
    <h3 class="text-light text-center text-uppercase">Enregistrez vous</h3>
</section>

<div class="row d-flex justify-content-center p-2 m-3">

    <div class="col-md-12 col-lg-9 bg-white p-2">
        ...
        <?php if (!$success) : ?>
            <form action="" method="post" autocomplete="off">
                <div class="row py-1">
                    ...
                    <div class="col-md-8 col-lg-8 p-2 m-2">
        ...
        <?php else : ?>
            <h1 class="text-center success-box"> Enregistrement éffectué avec succes, veuillez vous connecter <a href="./users/login.php" class="text-center btn btn-primary">Se connecter</a></h1>
        <?php endif; ?>
    </div>
</div>
<script>
